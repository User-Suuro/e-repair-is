Public Class ServicesExportModal
    ...
    Private Sub ExportClmdBtn_Click(sender As Object, e As EventArgs) Handles ExportClmdBtn.Click
        ...
        With servConst
            ...
            Dim keys As List(Of String) = formUtils.GetDictKey(columnHeaderMapping)
            Dim dt = dbHelper.GetRowByColValue(keys, servConst.svcTableStr, servConst.svcStatusStr, constants.getClaimedString)
            ...
            Dim title As String = $"Service Claimed Reports_{DateTime.Now:yyyy-MM-dd}"
